...
from ingestion import embeddings, vectorstore
...
def run_llm(query: str) -> Dict[str,Any]:
    ...
    system_prompt = (
        "You are a helpful AI assistance that answer questions about LangChain documentation."
        "You have access to a tool that retrieves relevant documentations."
